...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET websocketpp::websocketpp
                 ...
                 $<$<CONFIG:Debug>:${websocketpp_LINKER_FLAGS_DEBUG}>)
    set_property(TARGET websocketpp::websocketpp
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${websocketpp_INCLUDE_DIRS_DEBUG}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET websocketpp::websocketpp
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${websocketpp_LIB_DIRS_DEBUG}>)
    set_property(TARGET websocketpp::websocketpp
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${websocketpp_COMPILE_DEFINITIONS_DEBUG}>)
    set_property(TARGET websocketpp::websocketpp
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${websocketpp_COMPILE_OPTIONS_DEBUG}>)
